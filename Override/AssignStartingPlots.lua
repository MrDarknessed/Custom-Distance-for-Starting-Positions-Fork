...
function AssignStartingPlots.Create(args)
	print("****************** BEGIN CUSTOMIZE STARTING POSITIONS MOD ******************");
	print("Starting Distance Between Major Civilizations: ", MapConfiguration.GetValue("StartDistanceMajorCivs"));
	print("Starting Distance Between City-States: ", MapConfiguration.GetValue("StartDistanceMinorCivs"));
	print("Starting Distance Between City States and Major Civilizations: ", MapConfiguration.GetValue("StartDistanceMinorMajorCivs"));
	print("****************** END CUSTOMIZE STARTING POSITIONS MOD ******************");
	local instance  = {
...
function AssignStartingPlots:__MajorCivBuffer(plot)
	...
	local iMaxStart = MapConfiguration.GetValue("StartDistanceMajorCivs");
...
function AssignStartingPlots:__MinorMajorCivBuffer(plot)
	...
	local iMaxStart = MapConfiguration.GetValue("StartDistanceMinorMajorCivs");
...
function AssignStartingPlots:__MinorMinorCivBuffer(plot)
	...
	local iMaxStart = MapConfiguration.GetValue("StartDistanceMinorCivs");
